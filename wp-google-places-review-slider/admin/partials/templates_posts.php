 ...
 */
	...
	if (isset($_POST['wpfbr_submittemplatebtn'])){
		...
		$templatemiscarray['showicon']=htmlentities($_POST['wprevpro_template_misc_showicon']);
...
<tr class="wprevpro_row">
			...
			<tr>
				<td class="notice updated " colspan="2" style="border-left: 4px solid #d6d6d6;">
					<span><?php _e('Upgrade to the Pro Version of this plugin to access tons of slider settings! Get the Pro Version <a href="https://ljapps.com/wp-review-slider-pro/">here</a>!', 'wp-google-reviews'); ?></span>
				</td>
			</tr>
