 ...
 */
	...
	$savedplaceid = get_option('wprev_google_crawl_placeid');
...
<div class="w3-row-padding w3-padding-32">
  ...
  <div class=" w3-cell w3-cell-middle w3-padding-small">
    <input id="gplaceid" style="width: 300px;" value="<?php echo $savedplaceid; ?>" class="w3-input w3-border w3-round" type="text" placeholder="e.g.: ChIJOUW7JL0RYogRgDxol-LP_sU">
  </div>
  <div class=" w3-cell w3-cell-middle w3-padding-small">
...
<div id='divgoogletestresults' <?php if(!isset($previouscheck['foundplaceid']) || $previouscheck['foundplaceid']==''){echo 'style="display:none;"';} ?> class="w3-row-padding">
  <div class="w3-padding-small">
	<div id='googletestresults' <?php if($previouscheck['foundplaceid']==''){echo 'style="display:none;"';} ?>>
		<div class="w3-card-4">
