...
<div class="w3-bar w3-border w3-white">
  ...
  <a href="<?php echo $urlreviewlist; ?>" class="w3-bar-item w3-button <?php if($_GET['page']=='wp_google-reviews'){echo 'w3-green';} ?>"><i class="fa fa-list"></i> <?php _e('Reviews List', 'wp-google-reviews'); ?></a>
  ...
  <a href="https://ljapps.com/wp-review-slider-pro/" target="_blank" class="w3-bar-item w3-button"><i class="fa fa-external-link-square" aria-hidden="true"></i> <?php _e('Get Pro Version', 'wp-google-reviews'); ?></a>
</div>